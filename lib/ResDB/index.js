...
const nodeUtils_1 = require("../utils/common/nodeUtils");
const endpoints_1 = require("./endpoints");
class Resdb {
    constructor(nodes, tranport_module, config = {}) {
        this.api_prefix = process.env.RESDB_VERSION;
        this._nodes = (0, nodeUtils_1.normalize_nodes)(nodes, config.headers);
