...
import type { CreateAsset, InputObjectSerializable, TransactionOperationType, TransferAsset } from '../Transaction/interface';
/**
 * @interface Node
...
export interface Endpoint {
    get(...args: unknown[]): Promise<[AxiosResponse | undefined, Error | undefined]>;
}
/**
