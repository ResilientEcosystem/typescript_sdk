...
(function (ResdbEndpoints) {
    ...
    class TransactionsEndpoint extends NamespacedDriver {
        ...
        static prepare(config) {
            return Offchain_1.Offchain.prepareTransferTransaction(config);
        }
        static fulfill(transaction, privateKeys) {
            return Offchain_1.Offchain.fulfillTransaction(transaction, privateKeys);
        }
        /**
         * @method get
