 ...
 * under the License.
 */
import { Ed25519Sha256Json, PrefixSha256Json, PreimageSha256Json, RsaSha256Json, ThresholdSha256Json } from 'crypto-conditions/types/types';
...
export interface ThresholdSha256FulfillmentDetails extends FulfillmentDetails {
    type: string;
    threshold: number;
    subfulfillments?: (PreimageSha256Json | PrefixSha256Json | ThresholdSha256Json | RsaSha256Json | Ed25519Sha256Json)[];
