...
class Connection {
    ...
    _request(method, path, config) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.getSession().request(Object.assign({ method, url: path }, config));
            return response;
        });
    }
    getBackoffInMs() {
    ...
    request(method, path, backoffCap = 0, config) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            yield this.delay();
            let response;
            try {
                response = yield this._request(method, path, config);
                this.updateBackoffInMs(true, backoffCap, (_a = Number(response === null || response === void 0 ? void 0 : response.config['axios-retry'])) !== null && _a !== void 0 ? _a : 0);
                ...
                this.updateBackoffInMs(false, backoffCap, (_b = Number(response === null || response === void 0 ? void 0 : response.config['axios-retry'])) !== null && _b !== void 0 ? _b : 0);
                return [null, err];
            }
        });
    }
