 ...
 * under the License.
 */
import type { AxiosHeaders, AxiosRequestConfig, AxiosResponse, Method } from 'axios';
/**
...
export interface ConnectionInterface {
    ...
    getNodeUrl(): string;
    request(method: Method, path: string, config: RequestConfig): Promise<[AxiosResponse | undefined, Error | undefined]>;
}
/**
